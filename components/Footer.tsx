      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mb-4">
              Create stunning YouTube thumbnails with AI. Generate, edit, and perfect your thumbnails in minutes.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-black">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/features" className="text-gray-600 hover:text-black text-sm">
                  Features
                </Link>
              </li>
              <li>
                <Link href="/templates" className="text-gray-600 hover:text-black text-sm">
                  Templates
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/changelog" className="text-gray-600 hover:text-black text-sm">
                  Changelog
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/docs" className="text-gray-600 hover:text-black text-sm">
                  Documentation
                </Link>
              </li>
              <li>
                <Link href="/tutorials" className="text-gray-600 hover:text-black text-sm">
                  Tutorials
                </Link>
              </li>
              <li>
                <Link href="/support" className="text-gray-600 hover:text-black text-sm">
                  Support
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-100 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} YT Thumbnail AI. All rights reserved.
          </p>
